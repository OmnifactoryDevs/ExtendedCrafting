...
public class TileAdvancedCraftingTable extends TileEntity implements IInventory, IExtendedTable {
	...
	private NonNullList<ItemStack> matrix = NonNullList.withSize(25, ItemStack.EMPTY);
	...
	@Override
	public void clear() {
		this.matrix = NonNullList.withSize(25, ItemStack.EMPTY);
	...
	public ITextComponent getDisplayName() {
		return new TextComponentTranslation("tile.ec.table_advanced.name");
	}
}
